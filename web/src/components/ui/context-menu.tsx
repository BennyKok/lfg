...
import { popoverSurfaceClass } from "@/components/ui/dropdown-menu"
    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          ...
          className={cn(
            popoverSurfaceClass,
            "dark z-[170] max-h-(--available-height) min-w-48 origin-(--transform-origin) overflow-x-hidden overflow-y-auto text-popover-foreground duration-100 outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95 relative **:data-[slot$=-item]:focus:bg-foreground/10 **:data-[slot$=-item]:data-highlighted:bg-foreground/10 **:data-[slot$=-separator]:bg-foreground/5 **:data-[slot$=-trigger]:focus:bg-foreground/10 **:data-[slot$=-trigger]:aria-expanded:bg-foreground/10! **:data-[variant=destructive]:focus:bg-foreground/10! **:data-[variant=destructive]:text-accent-foreground! **:data-[variant=destructive]:**:text-accent-foreground!",
            className,
          )}
          {...props}
        />
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuContent
      ...
      className={cn("dark w-auto min-w-36", className)}
      {...props}
    />
  )
}
